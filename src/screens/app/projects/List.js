...
import { AppPagination,CustomTabComponent,LoaderBar,VerifyStepsBlock } from 'components'
...
import { ProjectGridList,ProjectCardList,FilterDrawer } from 'page-components/projects'
...
export const ProjectListScreen = () => {
  ...
  const isLoggedIn = useMemo(() => CommonUtility.isUserLoggedIn(authStatus),[authStatus])
    ...
    <div className="container">
      ...
      <div className="row mb-4 pb-md-2 pb-sm-0">
        <div className="col col-12 col-sm-12 col-md-9 col-lg-6 d-flex mb-2 mb-sm-0 pb-1 pb-sm-0">
          ...
          {isLoggedIn && <div className="mobile-hide">
            <CustomTabComponent
